...
const MapDrawer = props => {
  ...
  const title = isOpen ? (
    <span className="has-text-white title-flex">
      <Icon type="security-scan" style={{ fontSize: 24 }} />{' '}
      {props.selected.name}
    </span>
  ) : null
  const statusColor = s => {
      ...
      <Paragraph>
        <List itemLayout="horizontal" split={false}>
          <List.Item className="pb-0 pt-0">
            ...
            />
            <div style={{ color: statusColor(props.selected.status) }}>
        ...
        <List
          header={
            <div style={{ fontSize: 20 }} className="has-text-primary mb-0">
              <Icon type="environment" style={{ fontSize: 20 }} /> Location
            </div>
          }
        ...
        <List
          header={
            <div style={{ fontSize: 20 }} className="has-text-primary mb-0">
              <Icon type="global" style={{ fontSize: 18 }} /> Pages
            </div>
          }
          itemLayout="horizontal"
          split={false}
